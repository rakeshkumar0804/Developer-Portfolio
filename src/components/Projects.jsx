...
import { FiGithub, FiExternalLink, FiCheck, FiStar, FiLayers } from 'react-icons/fi';
      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-8">
        ...
        >
          ...
          <p className="mt-2 text-sm sm:text-base text-slate-400 max-w-xl font-sans">
            Real-world applications showcasing authentication, role-based workflows, REST API architecture, and database integrations.
          </p>
        </motion.div>
