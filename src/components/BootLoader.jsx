...
const LOG_LINES = [
  ...
  'operator recognized :: session #43',
];
    ...
    >
      ...
      <div className="relative z-10 flex items-center justify-between border-b border-[#00f0ff]/20 pb-3.5 tracking-widest text-[0.72rem]">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="px-2 py-0.5 rounded border border-[#00f0ff]/40 bg-[#00f0ff]/10 font-bold text-[#00f0ff]">
            ONLINE
          </span>
        </div>
      </div>
      ...
      <div className="relative z-10 max-w-xl mx-auto w-full my-auto space-y-7">
        <div className="space-y-2">
          ...
          <div className="h-2 w-full rounded-full bg-[#070e1a] border border-[#00f0ff]/30 overflow-hidden p-0.5">
            <motion.div
              className="h-full rounded-full bg-gradient-to-r from-[#00f0ff] to-[#7fe0ff] shadow-[0_0_15px_#00f0ff]"
        ...
        <div className="min-h-[140px] rounded-lg border border-[#00f0ff]/20 bg-[#070e1a]/90 p-4 space-y-1.5 text-[0.72rem] text-[#7fe0ff]">
