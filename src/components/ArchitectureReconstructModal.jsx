  ...
  'kohli-analytics': {
    ...
    milestones: [
      ...
      },
      {
        ...
        hash: 'c6019ef',
        time: 'T-00:00 [PROD]',
        message: 'release: GSAP 60 FPS transitions and live production deployment',
        activeNodes: ['dataset', 'parser', 'math', 'd3', 'gsap', 'canvas'],
        activeLinks: ['norm', 'calc', 'd3', 'gsap', 'render'],
        resolvedTitle: 'Smooth 60 FPS Dashboard Shipped',
        resolvedDesc: 'Hardware-accelerated analytics dashboard with zero frame drops during complex multi-series data morphing.',
      },
    ],
    nodes: [
      { id: 'dataset', label: 'Raw Inning Dataset', sub: '500+ Match JSONs', x: 80, y: 70, type: 'cyan' },
      { id: 'parser', label: 'Stat Normalization', sub: 'TypeScript Pipeline', x: 290, y: 70, type: 'cyan' },
      { id: 'math', label: 'Clutch Metric Engine', sub: 'Pressure Algorithms', x: 500, y: 70, type: 'amber' },
      { id: 'd3', label: 'D3.js Vector Engine', sub: 'Polar & Cartesian Maps', x: 80, y: 220, type: 'amber' },
      { id: 'gsap', label: 'GSAP Motion Controller', sub: '60 FPS Hardware Sync', x: 290, y: 220, type: 'emerald' },
